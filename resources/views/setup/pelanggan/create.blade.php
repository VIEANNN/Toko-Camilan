...
@section('content')
    <div class="container mx-auto bg-gray-800 text-white p-6 rounded-lg">
        ...
        <form action="{{ route('setup.pelanggan.store') }}" method="POST">
            @csrf
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="email" id="email" name="email" class="w-full px-4 py-2 border rounded bg-white text-gray-800" required>
            </div>

            <div class="mb-4">
                <label for="telepon" class="block text-sm font-semibold">Telepon</label>
                <input type="text" id="telepon" name="telepon" class="w-full px-4 py-2 border rounded bg-white text-gray-800" required>
            </div>

            <div class="mb-4">
                <label for="alamat" class="block text-sm font-semibold">Alamat</label>
                <textarea id="alamat" name="alamat" class="w-full px-4 py-2 border rounded bg-white text-gray-800"></textarea>
            </div>
